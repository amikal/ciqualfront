...
import { success } from '../../actions/ciqual/create';
import { retrieve, update, reset } from '../../actions/ciqual/update';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.ciqual.update.retrieveError,
    retrieveLoading: state.ciqual.update.retrieveLoading,
    updateError: state.ciqual.update.updateError,
    updateLoading: state.ciqual.update.updateLoading,
    deleteError: state.ciqual.del.error,
    deleteLoading: state.ciqual.del.loading,
    created: state.ciqual.create.created,
    deleted: state.ciqual.del.deleted,
    retrieved: state.ciqual.update.retrieved,
    updated: state.ciqual.update.updated,
  };
};
